    ...
    <div class="col-xs-12 col-md-6">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?= $button;?> Kegiatan_sub</h3>
	    ...
	    <div class="form-group">
            <label for="int">Id Kegiatan 1 <?php echo form_error('id_kegiatan_1') ?></label>
            <input type="text" class="form-control" name="id_kegiatan_1" id="id_kegiatan_1" placeholder="Id Kegiatan 1" value="<?php echo $id_kegiatan_1; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('kegiatan_sub') ?>" class="btn btn-default">Cancel</a>
	</form>
         </div>
        </div>
    </div>
