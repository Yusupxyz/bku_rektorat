    ...
    <div class="col-xs-12 col-md-6">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Kegiatan Sub Detail</h3>
            ...
            <div class="box-body">
        <table class="table">
	    <tr><td>Id Kegiatan 1</td><td><?php echo $id_kegiatan_1; ?></td></tr>
	    ...
	    <tr><td><a href="<?php echo site_url('kegiatan_sub') ?>" class="btn bg-purple">Cancel</a></td></tr>
	</table>
            </div>
        </div>
    </div>
