...
<div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">Tbl_saldo_awal</h3>
      ...
      <div class="box-body">
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $saldo_awal->sa_id;?>" />&nbsp;</td>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('saldo_awal/read/'.$saldo_awal->sa_id),'<i class="fa fa-search"></i>', 'class="btn btn-xs btn-primary"  data-toggle="tooltip" title="Detail"'); 
				echo ' '; 
