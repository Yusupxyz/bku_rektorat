    ...
    <div class="col-xs-12 col-md-6">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?= $button;?> Sub Kegiatan</h3>
        ...
        <div class="form-group">
            <label>Kegiatan</label>
                <select class="selectpicker form-control" name="kegiatan_id" id="kegiatan_id" data-placeholder="Pilih Kegiatan" data-live-search="true" style="width: 100%;">
                   <option value="0">-- Pilih Kegiatan -- </option>
                  <?php 
                    foreach ($kegiatan as $key => $value ) {
                      echo "<option value=\"$value->id_kegiatan\">($value->kode_kegiatan) $value->nama_kegiatan</option>";
                    }
                  ?>
               </select>
